...
export async function updateLikes(documentId, userId, action) {
  try {
    const response = await databases.getDocument(appwriteConfig.databaseId, appwriteConfig.videoCollectionId, documentId);
    ...
    await databases.updateDocument(appwriteConfig.databaseId, appwriteConfig.videoCollectionId, documentId, { likedBy });
